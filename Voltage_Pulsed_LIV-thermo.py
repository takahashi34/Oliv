...
class VPulse_LIV():
    ...
    def start_liv_pulse(self):
        ...
        # Mulitplication by 10 is due to a peculiarity of this oscilloscope
        self.scope.write(":TIMebase:RANGe %.6fus" %(0.5*pulseWidth*10))
        ...
        for V_s in voltageSourceValues:
            if ((prevPulserVoltage <= V_glitch_1 < V_s) or (prevPulserVoltage <= V_glitch_2 < V_s) or (prevPulserVoltage <= V_glitch_3 < V_s)):
                ...
                print("Wrote light point: %s" % light_ampl_osc)
                voltageData.append(voltage_ampl_device)
                currentData.append(current_ampl_device)
    ...
    def __init__(self, parent):
        ...
        # Device addresses
        connected_addresses = list(rm.list_resources())
        # Pulser, scope, and thermopile variables
        self.pulse_address = StringVar()
        self.scope_address = StringVar()
        ...
        # Set the pulser and scope variables to default values
        self.pulse_address.set('GPIB0::1::INSTR')
        self.scope_address.set('USB0::0x0957::0x17A2::MY51450354::INSTR')
        ...
        # Set voltage channel to 4
        self.voltage_channel.set(4)
        # Set trigger channel to 4
        self.trigger_channel.set(4)

        # Light measurement channel label
        self.light_channel_label = Label(self.instrFrame, text='Light address')
        ...
        self.thermopile_addr.grid(column=0, columnspan=2, row=5,
                             padx=5, pady=5, sticky='W')
